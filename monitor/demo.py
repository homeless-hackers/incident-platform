...
def main():
  ...
  wait()
  send_events("mock_data/events/jail/rob_jail_event1.json")
  wait()
  send_events("mock_data/events/rob_court_event5.json")
  wait()
  send_events("mock_data/events/rob_court_event6.json")
  wait()
  send_events("mock_data/events/rob_court_event7.json")
  wait()
